...
export const BudgetCardLoader: React.FC<BudgetCardLoaderProps> = ({ budgetId, categoryName, onPress }) => {
  ...
  return <BudgetCard summary={summary} categoryName={categoryName} onPress={() => onPress(summary)} />;
};
