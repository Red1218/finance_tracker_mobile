...
import { DecimalPrecision, FinanceSettings, Preferences } from '../../domain';
import { RepositoryResult, Result } from '../../../../platform/persistence';

export interface UpdateDecimalPrecisionRequest {
...
export class UpdateDecimalPrecisionUseCase {
  ...
  public async execute(request: UpdateDecimalPrecisionRequest): Promise<RepositoryResult<Preferences, Error>> {
